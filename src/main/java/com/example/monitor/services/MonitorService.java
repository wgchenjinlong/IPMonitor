...
//}
    public PingResult ping(String ipAddress, int pingTimes, double timeOut) {
        ...
        filePath = filePath +  ipAddress.replace(".", "_")  + ".log";
        try {
...
//                System.out.println(line);
                pingRecord(filePath, LocalDateTime.now() + ": " + line);
...
//    private String createFilePath(String ipAddr) {
//
//        String filePath = "D:" + File.separatorChar + "record" + File.separatorChar + LocalDate.now()
//                + File.separatorChar + ipAddr.replace(".", "_")  + ".log";
//
//        return filePath;
//    }
    ...
    private void pingRecord(String filePath, String record) {

        File file = new File(filePath);
        if (file.exists()) {

            FileUtils.writeFile(filePath, record);
        } else {
